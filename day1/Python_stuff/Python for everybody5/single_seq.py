...
# class is built for Windows machine with Firefox browser installed
# it will create custom profile to operate with so no panic here! :)
...
class single_query():
    ...
    def __init__(self, url='http://www.compbio.dundee.ac.uk/jpred/'):
        #check if custom profile is available
    ...
    def submit(self, submit_xpath=submit_xpath):
        try:
            ...
            print("Warning, sumbit button wasn`t found!")
    ...
    def download_results(self, result_archive=result_archive, in_queque=in_queque):
        try:
            ...
            while(True):
                ...
                #if original file and part are exists or part exists - continue
